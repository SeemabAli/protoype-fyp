      ...
      <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-gray-100 p-6 relative">
        ...
        <div className="relative max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-red-600 text-white font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
              <FiLogOut size={18} />
              Logout
            </button>
          </div>
          ...
          <div className="flex justify-between items-center bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 p-4">
            <div className="text-[#493737] font-semibold">Total Faculties: {faculties.length}</div>
            <button
                ...
                {faculties.map((f, idx) => (
                  <tr key={f._id} className="border-b hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-2 flex gap-3">
                      ...
                      <button
                        onClick={() => { setSelected(f); setDeleteOpen(true); }}
